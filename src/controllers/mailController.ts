                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td><strong style="font-size: larger;">${otp}</strong></td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <p>Cảm ơn bản đã sử dụng dịch vụ của chúng tôi.</p>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <br> Follow facebook admin? -> <a href="https://www.facebook.com/quangsang.nguyen.31945?mibextid=ZbWKwL" style="color: blue">Facebook</a>.
                  </td>
                </tr>
              </table>
            </div>
